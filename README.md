...
**新闻邮件阅读�?*是一款专为高效阅读和管理新闻类邮件而设计的开�?Flutter 应用。它集成�?AI 智能服务、笔记系统和强大的自定义功能，旨在提供一个纯净、无干扰的阅读体验�?
...
- **AI 智能服务**:
    - 邮件内容智能摘要（需配置）�?
    - 邮件翻译功能�?
- **白名单机�?*: 只接收来自您信任的发件人的邮件，屏蔽干扰信息�?
- **沉浸式阅�?*: 简洁的阅读界面，支持网页视图和纯文本视图�?
- **笔记与收�?*:
    - 为重要邮件添加笔记�?
    - 一键收藏关键邮件，方便日后查阅�?
...
1.  **环境准备**:
    ...
    - 配置好您的开发环�?(�?Android Studio, VS Code)�?
...
4.  **管理白名�?*: 在“设置”中管理白名单，只有白名单中的发件人邮件才会被接收�?
...
- **账户管理**: 添加、编辑或删除您的邮箱账户�?
- **AI与翻�?*: 配置第三�?AI �?翻译 服务�?API Key �?Endpoint�?
- **邮件同步配置**: 设置自动同步的时间间隔�?
- **白名单管�?*: 添加或移除信任的发件人邮箱地址�?
- **外观**: 切换浅色/深色主题�?
...
本项目采�?MIT 许可证。详情请�?[LICENSE](https://github.com/AullChen/news_email_reader/blob/main/LICENSE) 文件�?
...
<div align="center">
  <p>如果这个项目对您有帮助、使您感兴趣或者给您带来了欢乐，请给我们一�?⭐️</p>
